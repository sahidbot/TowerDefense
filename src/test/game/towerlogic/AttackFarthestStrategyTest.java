...
import game.towerlogic.AttackFarthestStrategy;
 ...
 */
public class AttackFarthestStrategyTest {
    @Rule
    ...
    private Tower tower;
    AttackFarthestStrategy strategy;
    ...
    public void BeforeTestingSetup(){
        ...
        strategy = new AttackFarthestStrategy(tower);
    }
